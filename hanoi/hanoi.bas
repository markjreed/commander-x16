...
1510 DIM PX(2) : REM X-COORDINATE OF THE CENTER OF PEG P
1515 DIM LX(2) : REM TEXT COLUMN FOR PEG P'S LABEL
1520 FOR P = 0 TO 2: PX(P) = BX + P * 96 : LX(P) = 8 + P * 12 :NEXT P
...
1910 :     FP = T(SP)      : REM OLD TARGET PEG IS NEW SOURCE PEG
1920 :     GET K$ : IF K$<>"" THEN M = 1 : PD = -1 : E = 1 : REM CHECK FOR KEY
1930 :     FOR Q=0 TO 9999 : NEXT Q: REM DELAY BEFORE NEXT MOVE
1940 :   NEXT M
1950 : NEXT PD
1960 NEXT E
1970 END
1980 REM ======================================================================
1985 REM SUBROUTINES
1990 REM ----------------------------------------------------------------------
...
3230 X1 = PX(F) - 4 * 2^SW(TD)
3240 X2 = PX(T) - 4 * 2^SW(TD)
